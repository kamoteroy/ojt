...
const AttachmentReviewTable = (props) => {
  ...
  const fetchAllAttachment = async () => {
    ...
    try {
      ...
      console.log("responseTicketReview", responseTicketReview);
      const attachmentResponse = await axiosInstance.get(
        `/getrecord/Attachment/TicketReviewId/${responseTicketReview.data.Id}`
      );
...
export default AttachmentReviewTable;
